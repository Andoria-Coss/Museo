...
<br>
            ...
            <section id="blog">
                <h1 align="center">Inventario</h1><br><br>
...
$query=mysqli_query($conexion,$sql);
   ...
   <div class="container mt-5">
                    <div class="row"> 
                        ...
                        <div class="col-md-8">
                            <table class="table" style="color:limegreen;">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <a href="delete.php?id=<?php echo $row['id'] ?>" onclick="return confirm('¿Está seguro de que desea eliminar?');" class="btn btn-danger">Eliminar</a>
                                                </th>
