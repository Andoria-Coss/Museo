        ...
        <div class="container px-4 px-lg-5">
            <div class="row">
                ...
                <div class="col-md-5 ms-auto">
                    ...
                    <h6 id="info">Para apartar tu pedido da <span style="color: red;">CLICK</span> en <span style="color: red;">Contactar al director</span><br>
                    y manda captura de tu lista de pedidos "Mis pedidos"</h6>
                </div>
            </div>
        </div>
    </section>
