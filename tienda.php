...
<br>
    ...
    <a href="#" class="btn-flotante" id="btnCarrito">Mis pedidos <span class="badge bg-success" id="carrito">0</span></a>
    <!-- Navigation-->
    <section class="py-5">
                        ...
                        <div class="col mb-5 productos" category="<?php echo $data['categoria']; ?>">
                            <div class="card h-100">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto agregar" data-id="<?php echo $data['id']; ?>"  href="#" style="color:black;">Agregar</a></div>
                                </div>
                            </div>
                        </div>
                <?php  }
