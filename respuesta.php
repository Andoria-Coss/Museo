  ...
  include_once("cabecera.html");
    ...
    <div class="contenedor2">
      ...
      <?php 
       ...
       <div class="regresar">
             <a href="agendar.php"><button class="reg" type="button" ALIGN="CENTER">Regresar al formulario</button></a> 
      </div>
      <h4 id="info" ALIGN="CENTER"><span style="color: white;">Para enviar tu pase da <span style="color: green;">CLICK</span> en <span style="color: green;">Contactar al                  director</span><br> y manda captura de tu pase de entrada</span></h4>
    </div>
